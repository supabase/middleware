/**
 * Postgres client helpers for the {@link withPostgres} middleware — the
 * RLS-scoped `db` client and the RLS-bypassing `adminDb` client it can
 * contribute.
 *
 ...
 * middleware needs no after-handler cleanup hook.
 */
